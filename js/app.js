(() => {
    ...
    function menuInit() {
        if (document.querySelector(".button-header")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".button-header")) {
                bodyLockToggle();
